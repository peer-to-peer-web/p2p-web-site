...
module.exports = class Video extends Nanocomponent {
  ...
  createElement (props) {
    ...
    return html`
      <div class="lh1-25 fs1 sm-fsvw6">
        <div
          class="bgc-black psr ${style}"
          style="padding-bottom: 56.25%"
        >
          ${this.state.active
            ? [this.elVideo, this.elTimeStamp]
  ...
  handleTimeUpdate (event) {
    ...
    if (this.data.timeout >= 60 * 15 && this.state.active) {
    ...
    return html`
      <div class="fc-white lh1-25">
        ...
        <div class="p0-5 psa t0 l0 r0 b0">
          <div class="lh1-25 p0-5 fs1 sm-fsvw6">
  ...
  renderVideo (src) {
    return html`
      <video
        ...
        class="grayscale psa t0 l0 w100 h100 curp"
  ...
  renderTimeStamp () {
    return html`
      <div class="psa t0 r0 p1 ff-mono pen">
